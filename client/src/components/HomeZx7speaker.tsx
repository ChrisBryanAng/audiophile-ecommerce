...
const HomeZx7speaker = () => {
  return (
    <div className="h-full w-full rounded-lg overflow-clip bg-header-zx7-mobile md:bg-header-zx7-tablet lg:bg-header-zx7-deskop bg-no-repeat bg-center bg-cover">
      <div className="h-[420px] w-full pl-6 md:pl-16 flex flex-col justify-center space-y-8 md:space-y-12">
