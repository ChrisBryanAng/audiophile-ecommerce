const HomeBestGear = () => {
  return (
    <div className="flex flex-col lg:flex-row-reverse items-center space-y-12 md:space-y-20 lg:space-y-0 lg:gap-4 md:w-full lg:w-[1370px]">
      ...
      <div className="flex flex-col md:items-center lg:items-start gap-11 md:gap-16 lg:flex-col lg:gap-10 lg:w-[50%]">
        ...
        <p className="md:w-[80%] lg:w-[71%] md:text-base tracking-wide text-center lg:text-start font-light px-2 lg:px-0 text-black2/60">
